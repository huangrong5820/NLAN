...
parser = argparse.ArgumentParser(description='NLAN')
parser.add_argument('--ext', type=str, default='sep.png',
                    help='dataset file extension')
parser.add_argument('--dir_data', type=str, default='G:/Datasets/SGN_BSD300/',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='G:/Datasets/SGN_BSD300/BenchmarkDenoise/', help='demollll image directory')
parser.add_argument('--data_train', type=str, default='DIV2KCOLORDENOISE',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='DenoiseColorSet68',
                    help='test dataset name')
parser.add_argument('--n_train', type=int, default=300,
                    help='number of training set')
parser.add_argument('--noise_sigma', type=int, default=70,
...
parser.add_argument('--single_psnr', type=str, default='./results/single_psnr.txt',
                    help='input batch size for training')
...
parser.add_argument('--n_val', type=int, default=68,
...
parser.add_argument('--model', default='nlan', #
                    help='model name')
...
parser.add_argument('--save', type=str, default='./Checkpoints/nlan-sigma=50-color',
                    help='file name to save')
parser.add_argument('--load', type=str, default='./Checkpoints/nlan-sigma=50-color',
